...
import { getReturnRequestsByDocument } from "../../../../services/returnRequest/getReturnRequestsByDocument";

const InputCPF = ({ setIsLoading, setReturnRequests }) => {
  const { control, handleSubmit, setError, clearErrors } = useForm();

  const onSubmit = (data) => {
    const document = data.document.replace(/\D/g, "");
    getReturnRequestsByDocument({ document, setIsLoading, setReturnRequests });
  };
